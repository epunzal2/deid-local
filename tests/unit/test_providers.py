...
from deid_local.adapters.llm.base import LLMRequest
...
def test_build_provider_dispatches_expected_types() -> None:
    ...
    openai_provider = build_provider(load_runtime_settings({"DEID_LLM_PROVIDER": "openai_http"}))
    vllm_provider = build_provider(load_runtime_settings({"DEID_LLM_PROVIDER": "vllm"}))
